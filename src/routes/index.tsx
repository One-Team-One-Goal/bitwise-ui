...
function RouteComponent() {
  return (
    <>
      <div className="bg-[var(--color-offwhite)] h-[calc(100vh-8rem)]">
        <img
          style={{
            userSelect: 'none',
      ...
      <div className="h-min md:h-screen flex flex-col items-center justify-center bg-[var(--color-lightpurple)] relative">
        <img
          style={{
            userSelect: 'none',
            WebkitUserSelect: 'none',
      ...
      <div className="h-min md:h-screen  flex flex-col items-center justify-center bg-[var(--color-bluez)] relative z-0">
        <img
          style={{
            userSelect: 'none',
            WebkitUserSelect: 'none',
      ...
      <div className="h-min md:h-[50vh] w-full flex flex-row bg-[var(--color-offwhite)]">
